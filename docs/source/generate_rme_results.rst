...
1000000 corals over Moore reef every year for 5 years (GBRMPA ID 16-071). The key information that is used to
generate economics input files from a set of RME runs is the result set folder filepath, in this case
"test_results_ext_moore_domain".
