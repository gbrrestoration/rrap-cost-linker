...
projects, including Cost Benefit Analysis (CBA), which looks at the difference in costs and
benefits, and Cost Effectiveness Anlysis (CEA), which looks at the cost per unit of
outcome. To perform these analyses, `CREAM` requires information on the predicted benefits
...
provide predicted outcomes and costs in a format suitable to input to `CREAM`. The
ecological outcomes are generated by calculating several metrics from the raw outputs
